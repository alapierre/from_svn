 ...
 */
public class DictionaryServiceImplTestA {
    
    static DictionaryServiceImpl dictionaryServiceImpl;
    
    @BeforeClass
    public static void setUpClass() throws Exception {
        DictionarysDAO dictionarysDAO = new DictionarysDAOFileSystemImpl(new File("src/test/resources/sample.xml"));
        dictionaryServiceImpl = new DictionaryServiceImpl(dictionarysDAO);
    }

    /**
     * Test of loadAll method, of class DictionaryServiceImpl.
     */
    @Test
    public void testLoadAll() {
        System.out.println("loadAll");        
        dictionaryServiceImpl.loadAll();
