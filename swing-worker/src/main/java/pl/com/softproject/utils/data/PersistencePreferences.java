package pl.com.softproject.utils.data;
...
/**
 * Preferences implementation for JNLP application.
 * Preferences are stored by using persistence service.
 *
...
final class PersistencePreferences extends AbstractPreferences {
    ...
    private static <T> T lookup(Class<T> type) throws UnavailableServiceException {
    ...
    private PersistencePreferences(PersistencePreferences parent, String name) throws MalformedURLException {
        super(parent, name);
